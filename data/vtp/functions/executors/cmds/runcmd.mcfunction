# Main
execute if entity @s[scores={VoidTP.SetSpawn=1..}] run function vtp:executors/verify/spawn
execute if entity @s[scores={VoidTP.RemoveSpawn=1..}] run function vtp:executors/verify/remspawn
...
execute unless score @s VoidTP.MinHeight matches 0 run function vtp:executors/verify/minheight
